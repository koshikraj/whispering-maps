...
export default function Footer(): React.JSX.Element {
  return (
    <footer className="text-center border-t border-gray-300 pt-8 lg:pt-10">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0 text-xs lg:text-sm text-gray-600">
        ...
        <div className="flex gap-6">
          <a 
            ...
            className="text-gray-600 no-underline hover:underline flex items-center gap-2 transition-colors"
          ...
          <a 
            href="https://www.instagram.com/whisperingmaps/" 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-gray-600 no-underline hover:underline flex items-center gap-2 transition-colors"
          ...
          <a 
            href="https://www.youtube.com/@WhisperingMaps" 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-gray-600 no-underline hover:underline flex items-center gap-2 transition-colors"
